...
function mesesDelAño(array) {
  ...
  // Tu código:
  var nuevoArray = [];
  var foundEnero = false;
  var foundMarzo = false;
  var foundNoviembre = false;
  ...
  if (foundEnero!=true || foundMarzo!=true || foundNoviembre!=true){
